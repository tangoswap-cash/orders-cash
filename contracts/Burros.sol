...
interface ISmartSwap {
    ...
    function swap(IERC20 fromToken,IERC20 destToken,uint256 amount,uint256 minReturn,uint256[] memory distribution,uint256 flags,uint256 deadline,uint256 feePercent) external payable returns(uint256);
}
